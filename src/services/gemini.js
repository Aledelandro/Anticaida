...
export async function generateLaunchQuestionnaireWithGemini(taskData) {
  return callGemini(`Eres el módulo de preguntas inteligentes de “Arranque 10”. El usuario quiere empezar una tarea, pero está bloqueado. Antes de generar una acción mínima, debes hacer de 3 a 6 preguntas útiles para cerrar el alcance.
